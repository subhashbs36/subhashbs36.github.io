      ...
      <div className="container-xs md:px-5">
            ...
            <div className="flex w-[25%] flex-col items-start gap-4 sm:w-full">
              <div className="flex justify-between gap-5 self-stretch">
                <div className="flex items-center gap-2">
                  ...
                  <Text as="p" className="text-[16px] font-medium text-white-a700">Subhash</Text>
                </div>
              ...
              <Heading as="h6" className="text-[16px] font-bold text-white-a700">Software Developer</Heading>
            </div>
            <div className="flex w-[15%] flex-col items-start gap-2.5 self-center sm:w-full">
              <Heading size="texts" as="p" className="text-[24px] font-medium text-white-a700 md:text-[22px]">Media</Heading>
        ...
        <div className="flex flex-col items-center justify-center gap-1 mt-2">
          <div className="flex justify-center items-center gap-1">
            <Text as="p" className="text-[16px] font-normal text-blue_gray-200">Special thanks to&nbsp;</Text>
            <a href="https://www.linkedin.com/in/b-s-vivek/" target="_blank" rel="noreferrer" className="cursor-pointer text-[16px] font-normal text-purple-200 hover:font-semibold">Vivek B S</a>
            <Text as="p" className="text-[16px] font-normal text-blue_gray-200">&nbsp;for his invaluable support in bringing this website to life.</Text>
          </div>
          <div className="flex justify-center items-center gap-1 mt-1">
            <Text as="p" className="text-[16px] font-normal text-blue_gray-200">Connect with him on&nbsp;</Text>
            <a href="https://www.linkedin.com/in/b-s-vivek/" target="_blank" rel="noreferrer" className="cursor-pointer text-[16px] font-normal text-purple-200 hover:font-semibold">LinkedIn</a>
            <Text as="p" className="text-[16px] font-normal text-blue_gray-200">&nbsp;to explore more of his amazing work!</Text>
          </div>
          <div className="flex justify-center items-center gap-1 mt-4">
            <Text as="p" className="text-[14px] font-normal text-blue_gray-200">© {new Date().getFullYear()} SubhashBS. All rights reserved.</Text>
          </div>
        </div>
      </div>
    </footer>
